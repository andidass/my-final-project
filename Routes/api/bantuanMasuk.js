...
router.post(
  ...
  async (req, res) => {
    ...
    bantuanMasukFields.dataBantuanMasuk.dataItemBantuan = [
      {
        jenisBantuan: req.body.num1,
        namaBarang: req.body.sub1,
        satuan: req.body.sat1,
        banyaknya: req.body.bnyk1,
        nilainya: req.body.nil1,
      },
      {
        jenisBantuan: req.body.num2,
        namaBarang: req.body.sub2,
        satuan: req.body.sat2,
        banyaknya: req.body.bnyk2,
        nilainya: req.body.nil2,
      },
    ];
    bantuanMasukFields.dataBantuanMasuk.dataItemBantuan =
      req.body.dataItemBantuan;
    // if (jenisBantuan)
