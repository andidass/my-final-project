...
export const getBantuanKeluar = () => async (dispatch) => {
  try {
    const res = await axios.get("/pos/bantuan-keluar/me");
...
export const getAllDataBantuanKeluar = () => async (dispatch) => {
  ...
  try {
    const res = await axios.get("/pos/bantuan-keluar");
    dispatch({
...
export const getBantuanKeluarById = (userId) => async (dispatch) => {
  try {
    const res = await axios.get(`/pos/bantuan-keluar/${userId}`);
...
export const createBantuanKeluar = (dataInit) => async (dispatch) => {
  try {
    ...
    const res = await axios.post("/pos/bantuan-keluar", dataInit, config);
...
export const insertBantuanKeluar = (dataInit, history) => async (dispatch) => {
  try {
    ...
    const res = await axios.put(
      "/pos/bantuan-keluar/input-bantuan-keluar",
      dataInit,
      config
    );
    ...
    history.push("/pos/bantuan-keluar");
  } catch (err) {
    const errors = err.response.data.errors;
